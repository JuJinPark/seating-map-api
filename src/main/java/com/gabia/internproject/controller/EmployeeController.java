...
public class EmployeeController {
    ...
    @ApiOperation(value = "모든 직원 조회", notes = "전체 직원정보를 조회하는 API.",response = EmployeeResponseDTO.class, responseContainer = "List")
...
//    public ResponseEntity<?> deleteEmployee(@PathVariable int id,@PathVariable int reservation-id) {
//        return (ResponseEntity<?>) ResponseEntity.status(200);
//    }
//
//
